(() => {
  ...
  function renderRows(items) {
    ...
    if (!items.length) {
      tbody.innerHTML = `<tr><td colspan="${EMPTY_COLSPAN}" class="text-center text-muted py-4">暂无快手上传记录</td></tr>`;
      mobileList.innerHTML = '<div class="mobile-empty text-muted">暂无快手上传记录</div>';
      return;
    }
